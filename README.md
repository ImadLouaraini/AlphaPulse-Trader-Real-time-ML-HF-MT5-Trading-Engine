...
AlphaPulseTrader/
│
├─ live_mt5_hf_optimized.py   # Main HF trading loop with async ticks
├─ ml_live_optuna.py          # ML features, LightGBM training, Optuna optimization
├─ money_management_mt5.py    # Risk, lot sizing, SL/TP computation
├─ signals.py                 # Barrier & correlation-based signal generation
